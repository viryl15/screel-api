...
Route::group(['prefix' => 'v1', 'middleware' => ['cors'],], function ($router) {
    ...
    Route::group(['prefix' => 'screel', 'middleware' => ['auth:api']], function (){
        ...
        Route::post('/react', [\App\Http\Controllers\ScreelReactionController::class, 'store'])->name('screel.react.api');
    });
    Route::group(['prefix' => 'tags', 'middleware' => ['auth:api']], function (){
        ...
        Route::get('/{search}', [\App\Http\Controllers\TagController::class, 'searchTags'])->name('tags.search.api');
    });
    ...
    Route::group(['prefix' => 'reactions', 'middleware' => ['auth:api']], function (){
        Route::get('/', [\App\Http\Controllers\ReactionController::class, 'index'])->name('reactions.api');
    });
});
